...
namespace RecipeApp2
{
    public partial class frmMain : Form
    {
        ...
        public frmMain()
        {
            ...
            connectionString = ConfigurationManager.ConnectionStrings["RecipeApp2.Properties.Settings.Database2ConnectionString"].ConnectionString;
        }
        ...
        {
            string query = "INSERT INTO Recipe VALUES (@RecipeName, 80, 'Some Text')";
